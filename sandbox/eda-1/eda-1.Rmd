---
title: "EDA, version 0.1"
output:
  html_document:
    css: ~/GitHub/income-inequality/gender-income-inequality-nlsy/libs/css/sidebar.css
    keep_md: yes
    toc: yes
---
...
```{r age-distribution, echo=TRUE, results='show', message=FALSE}
```
